...
@Component({
  selector: 'app-reactive-template-assign',
  templateUrl:'./reactive-template-assign.component.html',
  styleUrls: ['./reactive-template-assign.component.css']
})
export class ReactiveTemplateAssignComponent implements OnInit {
  ...
  createForm(){
    this.myReactiveForm = new FormGroup({
      'firstName': new FormControl('',[Validators.required, Validators.maxLength(5) ,Validators.minLength(5) , this.fNameRange.bind(this)]),
      'lastName': new FormControl('',[Validators.required, Validators.maxLength(10), this.lNameRange.bind(this)]),
