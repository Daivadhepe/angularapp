...
@Component({
  selector: 'app-react-project-form',
  templateUrl:  './react-project-form.component.html',
  styleUrls: ['./react-project-form.component.css']
})
export class ReactProjectFormComponent implements OnInit {
    ...
    }
    {
      ...
      NaEmails(control:FormControl): Promise<any> | Observable<any> {
        const myResponse = new Promise<any>((resolve, reject) => {
          setTimeout(() => {
            if(control.value === 'dhepedaivashala63@gmail.com'){
